...
public class InfoSender : MonoBehaviourPun {
    ...
    public void SendGameOver(string info, string cube) {
        byte evCode = 20;

        string[] content = new string[] {info, cube};

        RaiseEventOptions raiseEventOptions = new RaiseEventOptions { Receivers = ReceiverGroup.Others };
        SendOptions sendOptions = new SendOptions { Reliability = true };
        PhotonNetwork.RaiseEvent(evCode, content, raiseEventOptions, sendOptions);
    }
    public void RotateIncrease(int content)
    {
        byte evCode = 21;
        RaiseEventOptions raiseEventOptions = new RaiseEventOptions { Receivers = ReceiverGroup.Others };
        SendOptions sendOptions = new SendOptions { Reliability = true };
    ...
    public void AttackIncrease(int content)
    {
        byte evCode = 22;
        RaiseEventOptions raiseEventOptions = new RaiseEventOptions { Receivers = ReceiverGroup.Others };
        SendOptions sendOptions = new SendOptions { Reliability = true };
    ...
    public void UnitsLostIncrease(int content)
    {
        byte evCode = 23;
        RaiseEventOptions raiseEventOptions = new RaiseEventOptions { Receivers = ReceiverGroup.Others };
        SendOptions sendOptions = new SendOptions { Reliability = true };
